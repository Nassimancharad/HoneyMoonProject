    ...
    public partial class initial : Migration {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Datum", x => x.datum);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AfspraakTijd = table.Column<DateTime>(nullable: false),
                    Tijden = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tijden", x => x.AfspraakTijd);
                    table.ForeignKey(
                        name: "FK_Tijden_Datum_Tijden",
                        column: x => x.Tijden,
                        principalTable: "Datum",
                        principalColumn: "datum",
                        onDelete: ReferentialAction.Restrict);
